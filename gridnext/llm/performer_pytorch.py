'''
Adapted from scBERT: https://github.com/TencentAILabHealthcare/scBERT/tree/master
'''
...
def orthogonal_matrix_chunk(cols, device = None):
    ...
    #q, r = torch.qr(unstructured_block.cpu(), some = True)           # deprecated in favor of below
...
class Gene2VecPositionalEmbedding(nn.Module):
    def __init__(self, dim, max_seq_len):
        super().__init__()
        gene2vec_dat = pkgutil.get_data('gridnext.llm', 'gene2vec_16906.npy')
        gene2vec_weight = np.load(BytesIO(gene2vec_dat))
